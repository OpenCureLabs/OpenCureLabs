...
- budget per-run tracking, website upgrade, docs cleanup

## v0.51.2 (2026-03-24)

### Fix

- batch monitor stall escalation, orphan recovery, and hard timeout
...
- **website**: add logo and favicon to header

## v0.50.7 (2026-03-24)

### Fix

- **worker**: write critique row when sweep PATCHes result
...
- export PROJECT_DIR + remove 2>/dev/null from gum spin

## v0.50.4 (2026-03-24)

### Fix

- **publish**: fix R2 contribute flow — heredoc stdin + optional critique

## v0.50.3 (2026-03-24)

### Fix

- **dashboard**: suppress Zellij OSC 11 color query artifacts

## v0.50.2 (2026-03-24)

### Fix

- **dashboard**: skip Vast.ai prompt for My Data single runs

## v0.50.1 (2026-03-24)

### Fix

- **dashboard**: replace gum file with gum input for file prompts
...
- **genesis**: arrow-key menus for task count and pool size
...
- **genesis**: improve task/pool prompts with descriptions and auto-recommendations
...
- **genesis**: add My Data support — run all tasks against uploaded files

## v0.44.5 (2026-03-24)

### Fix

- **dashboard**: Alt+S needs bash -c for $PROJECT_DIR expansion

## v0.44.4 (2026-03-24)

### Fix

- **dashboard**: Alt+S wrapper script prevents self-kill
- **dashboard**: Alt+S wrapper script prevents self-kill
...
- **dashboard**: Alt+S kills existing research pane before opening new one
